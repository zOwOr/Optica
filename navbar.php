...
<nav class="navbar navbar-default  ">
  <div class="container-fluid ">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="#">Óptica Rodriguéz</a>
    </div>
    ...
    <div class="collapse navbar-collapse " id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav ">
        ...
        <li class="<?php echo $active_stock;?>">
          <a href="stock.php">
        ...
        <li class="<?php echo $active_reportes;?>"><a href="reportes-graficas.php"><i  class='glyphicon glyphicon-thumbs-up'></i> Reportes & Graficas</a></li>
        ...
        <li class="<?php echo $active_notasVenta;?>"><a href="nota-venta.php"><i  class='glyphicon glyphicon-lock'></i> Notas de Venta</a></li>
        <li class="<?php echo $active_proveedor;?>"><a href="proveedores.php"><i  class='glyphicon glyphicon-lock'></i> Proveedores</a></li>
