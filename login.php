...
<head>
  ...
  <title>Optica Rodriguez | Ingreso</title>
	<!-- Latest compiled and minified CSS -->
	<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.6/css/bootstrap.min.css" integrity="sha384-1q8mTJOASx8j1Au+a5WDVnPi2lkFfwwEAa8hDDdjZlpLegxhjVME1fgjWPGmkzs7" crossorigin="anonymous">
    <!-- CSS  -->
    <link href="css/login.css" type="text/css" rel="stylesheet" media="screen,projection"/>
	<link rel="icon" href="img/invoice-icon.jpg" sizes="32x32" type="image/jpg">
	...
	background-image: linear-gradient(rgba(0, 0, 0, 0.8), rgba(0, 0, 0, 0.7)), url('./img/optica.jpeg');
  opacity: 1  no-repeat center center fixed;
...
print "<p>&nbsp;</p> #server: ". $_SERVER['SERVER_NAME'];
